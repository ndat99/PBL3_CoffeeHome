    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        QueueID = c.String(nullable: false, maxLength: 20),
                        OrderID = c.String(nullable: false, maxLength: 20),
                        BaristaID = c.String(maxLength: 20),
                ...
                .ForeignKey("dbo.Users", t => t.BaristaID)
                .Index(t => t.OrderID)
                .Index(t => t.BaristaID);
                ...
                c => new
                    {
                        ...
                        DiscountID = c.String(maxLength: 20),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        DiscountID = c.String(nullable: false, maxLength: 20),
            ...
            CreateTable(
                ...
                c => new
                    {
                        OrderItemID = c.String(nullable: false, maxLength: 20),
                        OrderID = c.String(nullable: false, maxLength: 20),
                        MenuItemID = c.String(nullable: false, maxLength: 20),
